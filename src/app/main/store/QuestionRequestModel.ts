...
export const createGroupAndFulfillRequest = async (id: number) => {
    return await axios.post<Group>(`/api/admin/question-requests/${id}`);
}
...
export const submitQuestionRequest = async (questionRequest: QuestionRequest) => {
